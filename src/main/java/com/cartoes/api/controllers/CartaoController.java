 ...
 */
 ...
 public ResponseEntity<List<Cartao>>
buscarPorClienteId(@PathVariable("clienteId") int clienteId) {
 try {
 log.info("Controller: buscando cartões do cliente de ID: {}",
clienteId);
 Optional<List<Cartao>> listaCartoes =
cartaoService.buscarPorClienteId(clienteId);
 ...
 */
 ...
 return ResponseEntity.ok("Cartao de id: " + id + " excluído comsucesso");
 } catch (ConsistenciaException e) {
